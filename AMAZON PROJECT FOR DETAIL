# AMAZON-SALES-ANALYSIS FOR THE DASHBOARD TO EXCEL
...
The Dashboard is fully Dynamic and each category of data is fully functional. It gives a basic overview of every  seasons all the way from amazon sales.
